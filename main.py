...
def build_prompt(persona_data, insults_data):
    ...
    if persona_data:
        ...
        Особенности:
        - Пишешь длинные сообщения. 
        - Не извиняешься.
        - Можешь переходить на "ты".
        - Сдержанный. Используешь слова паразиты, но не часто. Типо, чо, че, ну, оло
        ...
        Дополнительная информация (из вики): Вспыльчивый.
        """
